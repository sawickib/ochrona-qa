...
\begin{solution}
\begin{description}
\item[Kopia pełna], zawsze musi byź wykonana na początku. Tworzymy pełny obraz archiwizowanych plików bez względu na to, czy od wykonania ostatniego obrazu w plikach zaszły jakieś zmiany. Największy rozmiar i najdłuższy czas wykonywania.
