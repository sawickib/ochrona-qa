...
Obrona przed tego typu atakami polega na sprawdzaniu danych wejściowych przed wykorzystaniem tych danych w programie. Dane powinny być sprawdzane z negatywnym nastawieniem, czyli sprawdzamy czy dane są poprawne, a nie czy dane są błędne. Szczególną uwagę należy zwrócić na:
\begin{itemize}
