...
\begin{solution}
Funkcja silnie bezkonfliktowa wymaga, aby dla każdego $x$ niemożliwe było (w praktycznych zastosowaniach, nie w teoretycznych rozważaniach) znalezienie takiego $x'$ różnego od $x$, że $H(x) = H(x')$. W praktyce takie funkcje haszujące nie produkują kolizji.
\end{solution}
