...
\begin{solution}
Polega on na projektowaniu oprogramowania pod kątem minimalizacji strat po ewentualnym złamaniu zabezpieczeń.
\end{solution}
...
Technika ta jest używana do:
    ...
    automatycznego blokowania wiadomości zawierające dane hasła lub url podstrony (cenzura),
