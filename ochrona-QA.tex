...
\begin{solution}
Zastosowanie funkcji haszującej sprawia, że podpis cyfrowy jest znacznie krótszy od dokumentu, a jego wiarygodność
można sprawdzić bez podawania treści samego dokumentu.
\end{solution}
